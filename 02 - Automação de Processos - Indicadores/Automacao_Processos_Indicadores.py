...
emails = pd.read_excel(r'D:\estudos\python\02 - Automação de Processos - Indicadores\Bases de Dados\Emails.xlsx')
lojas = pd.read_csv(r'D:\estudos\python\02 - Automação de Processos - Indicadores\Bases de Dados\Lojas.csv', encoding='latin1', sep=';')
vendas = pd.read_excel(r'D:\estudos\python\02 - Automação de Processos - Indicadores\Bases de Dados\Vendas.xlsx')
...
caminho_backup = pathlib.Path(r'D:\estudos\python\02 - Automação de Processos - Indicadores\Backup Arquivos Lojas')
...
Segue em anexo os rankings do ano e do dia de todas as lojas.Loja
